...
از قسمت ریلیز ها آخرین نسخه را دانلود و نصب کنبد . اگر خطای گوگل پروتکت داد مطابق تصویر زیر روی این نوشته را لمس کنید در غیر این صورت به راحتی نصب می شود. 
<div align="center">
